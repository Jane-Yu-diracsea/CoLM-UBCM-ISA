...
!      SITE_flake_urb = SITE_flake_urb * 100
      ...
      SITE_flake_urb = min(SITE_flake_urb, 1.-SITE_fgimp)
      SITE_fgper     = max(1e-10, 1.- (SITE_fgimp-SITE_froof)/(1.-SITE_froof-SITE_flake_urb))
      SITE_froof     = SITE_froof/(1.-SITE_flake_urb)
      SITE_fveg_urb  = min(SITE_fveg_urb, 1.-SITE_flake_urb-SITE_fgimp)
      SITE_fveg_urb  = SITE_fveg_urb  * 100
      SITE_flake_urb = SITE_flake_urb * 100
